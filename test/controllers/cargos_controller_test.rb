...
class CargosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cargo" do
    assert_difference('Cargo.count') do
      post cargos_url, params: { cargo: { atividade: @cargo.atividade, descricao: @cargo.descricao, fornecedor_id: @cargo.fornecedor_id } }
    end
  ...
  test "should update cargo" do
    patch cargo_url(@cargo), params: { cargo: { atividade: @cargo.atividade, descricao: @cargo.descricao, fornecedor_id: @cargo.fornecedor_id } }
