...
class FornecedoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedor" do
    assert_difference('Fornecedor.count') do
      post fornecedores_url, params: { fornecedor: { dataDeAdmissao: @fornecedor.dataDeAdmissao, dataDeNascimento: @fornecedor.dataDeNascimento, nome: @fornecedor.nome, salario: @fornecedor.salario, sobrenome: @fornecedor.sobrenome } }
    end
  ...
  test "should update fornecedor" do
    patch fornecedor_url(@fornecedor), params: { fornecedor: { dataDeAdmissao: @fornecedor.dataDeAdmissao, dataDeNascimento: @fornecedor.dataDeNascimento, nome: @fornecedor.nome, salario: @fornecedor.salario, sobrenome: @fornecedor.sobrenome } }
